...
if (!mysqli_query($con, $logQuery)) {
    ...
    die("Error logging action: " . mysqli_error($con));
        ...
        echo "<script>alert('แก้ไขข้อมูลสำเร็จ'); window.location.href = 'manageUser.php';</script>";
    } else {
...
<body>
    ...
    <a href="manageUser.php" class="btn btn-secondary">ยกเลิก</a>
    <a href="#" class="btn btn-danger" onclick="confirmDelete(<?= $id ?>, 'nameTable')">ลบผู้ใช้นี้</a>
</form>
    </div>
</body>
