...
<body>
    ...
    <div class="container mt-4">
        <h2 class="text-center">จัดการผู้ใช้งานสต็อก</h2>
        <a href="addnewuser.php" class="btn btn-success mt-3">เพิ่มผู้ใช้ใหม่</a>
    ...
    function loadStockData(table = 'all', search = '') {
        $.ajax({
            url: "search_manageUser.php", // ไฟล์ PHP ที่จะประมวลผลการค้นหา
            method: "POST",
            data: {
